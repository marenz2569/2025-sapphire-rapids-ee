	...
	\institute{Institute of Computer Engineering \phantom{Push the institute name below the line.}}
	\chair{Chair of Computer Architecture \phantom{Push the chair name on then next line.}}


	\newcommand*{\Title}{An Analysis of the Intel Sapphire Rapids Architecture's Energy Efficiency Features}
...
\referee{Prof. Dr. Wolfgang E. Nagel \and Prof. Dr.-Ing. Diana G\"ohringer}
