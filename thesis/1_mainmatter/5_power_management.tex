...
The frequency is switched back and a random time between \SI{0}{\us} and \SI{5000}{\us} is waited before being repeated for \SI{1000}{} times.
...
At around \SI{2000}{\us} we see a repeating pattern with a period of \SI{1600}{\us}, which intern contains samples which are not spread across the x-axis as previous, but are aligned with a period of \SI{200}{\us}.
Interestingly the number of samples which are above around a transition latency of around \SI{900}{\us} decrease with an increase in frequency change.
...
Furthermore do most samples not align on a specific transition latency but are spread across a region of \SI{200}{\us}.
...
Further work is required for explaing what causes the high latencies for some frequency changes.
...
\begin{figure}[]
    ...
    \caption{\label{fig:pstate_latencies_time_dependance}Dependance of the time last frequency change detection events for the transition from \SI{1.2}{\GHz} to \SI{1.8}{}, \SI{1.9}{}, \SI{2.0}{} and \SI{2.1}{\GHz}. For better lines for bins of size \SI{1600}{\us} and \SI{200}{\us} have been included for the x and y-axis respectively.}
\end{figure}
