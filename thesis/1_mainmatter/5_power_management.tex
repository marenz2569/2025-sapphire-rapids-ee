...
We could not detect a change in frequency, this is consitent with the previous Intel Server processor Skylake-SP.
...
\todoms{fix colors selection for the license levels}
