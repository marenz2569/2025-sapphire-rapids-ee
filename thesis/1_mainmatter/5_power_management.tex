...
Starting with Sapphire Rapids, Intel changed their design on server processors to have shared FIVR for a set of up to four cores.
...
For the measurment we disabled C-states, changed the cores to the lowest frequency (\SI{800}{\MHz}) and run a while true loop on one core.
