...
It is far below the limit of \SI{290}{\us} for PC6, as PC2 is used to to allow memory to cross the package~\cite{Intel_PowerManagementTechnologyReviewIceLake}~\cite[p.~48]{EnergyEfficientServers_2015}.
