...
\begin{figure}[]
    \centering
    \includegraphics[width=0.45\columnwidth]{fig/ftalat_99percentQuantile_hati.pdf}
    \caption{\label{fig:pstate_latencies_99percentQuantile}99th percentile of P-state switching latencies.}
\end{figure}
