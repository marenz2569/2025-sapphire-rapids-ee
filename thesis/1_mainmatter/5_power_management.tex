...
Core frequencies can have an impact on other cores as shown by Schöne et al. for cores on the Alder Lake Platform which have the same core micro-architecture~\cite{Schoene_2024_Alder_Lake}.
