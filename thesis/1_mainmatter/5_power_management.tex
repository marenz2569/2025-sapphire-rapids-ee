...
\begin{figure}[]
    \centering
    \includegraphics[width=0.8\columnwidth]{fig/ftalat_median_hati.pdf}
    \caption{\label{fig:pstate_latencies_median}Median P-State switching latencies of the Sapphire Rappids processor.
    We see two different behaviour, a low latency for switching to a lower frequency and switching up to \SI{1.8}{\GHz}, and a higher latency for switching above \SI{1.9}{\GHz}.
    On the boundary to the lower frequency region some source/target frequency pairs emit a higher transition latency.}
\end{figure}
