...
\begin{figure}[]
    \centering
    \includegraphics[width=0.45\columnwidth]{fig/C6_onecolumn.pdf}
    \caption{\label{fig:c6_latencies}C-state latencies of C6 transition.}
\end{figure}

\begin{itemize}
    \item Repeat measurement for remote socket and powersave governor.
