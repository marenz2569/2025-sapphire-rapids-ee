...
For package counters \figref{rapl-update-intervals-package} shows the difference between the newly added timestamp in the RAPL register and using the rdtsc as the source of the timestamp.
...
For dram counters \figref{rapl-update-intervals-dram} does not show a change in resolution with rapl filters.
