...
I extended the measurement for RAPL granularity proposed by Schöne et al.~\cite{Schoene_2024_Alder_Lake}.
...
\begin{figure}[]
    ...
    The left plot uses the \textbf{rdtsc} function to get a timestamp for the RAPL measurement, the right uses the newly integrated timestamp in the \textbf{MSR_PACKAGE_ENERGY_TIME_STATUS} MSR.}
\end{figure}
