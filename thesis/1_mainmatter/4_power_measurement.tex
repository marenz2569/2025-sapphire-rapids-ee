...
\todoms{For the nominal core frequency of \SI{2}{\GHz}, I plot the package counters in~\figref{rapl-update-intervals-package} and dram counters in TODO.} %~\figreg{rapl-update-intervals-dram}.
\todoms{I display the plots for all frequencies in appendix TODO. cite the plot for the next sentance.}
