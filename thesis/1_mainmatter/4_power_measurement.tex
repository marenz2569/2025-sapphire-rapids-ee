...
DRAM counters, displayed in \figref{rapl-update-intervals-dram} show an average update interval of around \SI{1.5}{\ms}--\SI{1.6}{\ms}, this does not change with RAPL filters enabled.
