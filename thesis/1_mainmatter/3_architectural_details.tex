...
\begin{sidewaystable}[t]
	...
	\begin{tabular}{r|lll}
		...
		Decoder fetch bandwidth [\SI{}{\byte\per cycle}] & \SI{16}~\cite{Wikichip_SkylakeSP} & \SI{32}{}~\cite{Intel_Optimization_Reference_Manual_050} & \\
		...
		\rowcolor[HTML]{EFEFEF}  & 1G: 16~\cite{Intel_2017_Skylake_SP} & & \\
		Mid-level Cache & & & \\
		\bottomrule
		%\vspace{6mm}
	\end{tabular}
